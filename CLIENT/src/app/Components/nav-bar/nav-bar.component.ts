...
export class NavBarComponent implements OnInit {
  ...
  onNofiClick() {
    this.bellList.style.visibility =
      this.bellList.style.visibility == 'visible' ? 'hidden' : 'visible';
  ...
  onMessClick() {
    this.messList.style.visibility =
      this.messList.style.visibility == 'visible' ? 'hidden' : 'visible';
  ...
  onBlockScrollBody() {
    if (
      this.bellList.style.visibility == 'visible' ||
      this.messList.style.visibility == 'visible'
    )
      this.document.body.style.overflow = 'hidden';
    else this.document.body.style.overflow = 'visible';
  }

  search(ev: any) {
    this.router.navigate(['/search'], {
      queryParams: { keyword: (ev.target as HTMLInputElement).value },
    });
  }
